                ...
                <div className="mt-20 relative overflow-hidden rounded-[2rem] shadow-2xl">
                    <div className="relative z-10 p-12 text-center text-white bg-[#ff6a00]">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <a href="mailto:jegnitshapewear@gmail.com" className="px-8 py-4 bg-white/10 backdrop-blur-md border border-white/20 text-white font-bold rounded-xl hover:bg-white/20 transition-all text-center shadow-lg">
                                Email Privacy Team
                            </a>
